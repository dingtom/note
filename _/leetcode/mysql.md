...
- [ 远程连接](#head63)
	- [ 删除用户](#head64)
- [ 使用pymysql连接上mysql数据库服务器，创建了一个数据库对象；](#head65)
...
## <span id="head26">删除字段(ALTER DROP COLUMN)  </span>
```mysql
