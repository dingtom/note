...
- [ 堆排序](#head8)
- [ 归并排序](#head9)
	- [递归（分成两个子序列， 将两个排好的子序列合并）](#head10)
- [ 计数排序](#head11)
	- [ arr每个元素放进max-min个桶里，依次从桶里取出放进arr](#head12)
- [ 桶排序](#head13)
- [ 基数排序](#head14)
...
# <span id="head11"> 计数排序</span>


##### <span id="head12"> arr每个元素放进max-min个桶里，依次从桶里取出放进arr</span>
