- [ 汇总](#head1)
- [ 模拟](#head2)
	- [[134\. 加油站](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/gas-station/)](#head3)
	- [[146\. LRU缓存机制](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/lru-cache/)](#head4)
	- [[202\. 快乐数](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/happy-number/)](#head5)
	- [[289\. 生命游戏](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/game-of-life/)](#head6)
	- [[371\. 两整数之和](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/sum-of-two-integers/)](#head7)
	- [[412\. Fizz Buzz](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/fizz-buzz/)](#head8)
- [ 数组](#head9)
	- [[376\. 摆动序列](https://leetcode-cn.com/problems/wiggle-subsequence/)](#head10)
- [ 二分查找](#head11)
- [ 链表](#head12)
	- [[24. 反转链表](https://leetcode-cn.com/problems/fan-zhuan-lian-biao-lcof/)](#head13)
		- [ 递归](#head14)
		- [ 双指针](#head15)
- [ 找出环的入口点：](#head16)
- [ 堆栈](#head17)
...
- [ 树、线段树](#head19)
- [ 排序、二分检索、滑动窗口](#head20)
	- [ [376\. 摆动序列](https://leetcode-cn.com/problems/wiggle-subsequence/)](#head21)
- [ 动态规划](#head22)
	- [[剑指 Offer 10- II. 青蛙跳台阶问题](https://leetcode-cn.com/problems/qing-wa-tiao-tai-jie-wen-ti-lcof/)](#head23)
	- [[62. 不同路径](https://leetcode-cn.com/problems/unique-paths/)](#head24)
	- [[64. 最小路径和](https://leetcode-cn.com/problems/minimum-path-sum/)](#head25)
- [ 图论](#head26)
- [ 数学、位运算](#head27)
- [ 字符串](#head28)
	- [【125\. 验证回文串](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/valid-palindrome/)](#head29)
	- [[131\. 分割回文串](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/palindrome-partitioning/)](#head30)
	- [[139\. 单词拆分](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/word-break/)](#head31)
	- [[140\. 单词拆分 II](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/word-break-ii/)](#head32)
	- [[208\. 实现 Trie (前缀树)](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/implement-trie-prefix-tree/)](#head33)
	- [[212\. 单词搜索 II](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/word-search-ii/)](#head34)
	- [[242\. 有效的字母异位词](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/valid-anagram/)](#head35)
	- [[387\. 字符串中的第一个唯一字符](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/first-unique-character-in-a-string/)](#head36)
	- [[344\. 反转字符串](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/reverse-string/)](#head37)
	- [ [3.无重复字符的最长子串长度](https://leetcode-cn.com/problems/longest-substring-without-repeating-characters/)](#head38)




# <span id="head1"> 汇总</span>

[(10 封私信) 互联网公司最常见的面试算法题有哪些？ - 知乎 (zhihu.com)](https://www.zhihu.com/question/24964987/answer/586425979)

# <span id="head2"> 模拟</span>

## <span id="head3">[134\. 加油站](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/gas-station/)</span>
...
## <span id="head4">[146\. LRU缓存机制](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/lru-cache/)</span>
...
## <span id="head5">[202\. 快乐数](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/happy-number/)</span>
...
## <span id="head6">[289\. 生命游戏](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/game-of-life/)</span>
...
## <span id="head7">[371\. 两整数之和](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/sum-of-two-integers/)</span>
...
## <span id="head8">[412\. Fizz Buzz](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/fizz-buzz/)</span>
...
# <span id="head9"> 数组</span>

## <span id="head10">[376\. 摆动序列](https://leetcode-cn.com/problems/wiggle-subsequence/)</span>
...
# <span id="head12"> 链表</span>



## <span id="head13">[24. 反转链表](https://leetcode-cn.com/problems/fan-zhuan-lian-biao-lcof/)</span>

>定义一个函数，输入一个链表的头节点，反转该链表并输出反转后链表的头节点。
### <span id="head14"> 递归</span>
>1. 定义递归函数功能，返回反转后头节点
...
# <span id="head17"> 堆栈</span>



# <span id="head18"> 哈希、队列</span>



# <span id="head19"> 树、线段树</span>





# <span id="head20"> 排序、二分检索、滑动窗口</span>
...
```
## <span id="head21"> [376\. 摆动序列](https://leetcode-cn.com/problems/wiggle-subsequence/)</span>
...
# <span id="head22"> 动态规划</span>

**案例一、简单的一维 DP**

## <span id="head23">[剑指 Offer 10- II. 青蛙跳台阶问题](https://leetcode-cn.com/problems/qing-wa-tiao-tai-jie-wen-ti-lcof/)</span>
...
## <span id="head24">[62. 不同路径](https://leetcode-cn.com/problems/unique-paths/)</span>
...
## <span id="head25">[64. 最小路径和](https://leetcode-cn.com/problems/minimum-path-sum/)</span>
...
# <span id="head26"> 图论</span>



# <span id="head27"> 数学、位运算</span>





# <span id="head28"> 字符串</span>
...
```
## <span id="head29">【125\. 验证回文串](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/valid-palindrome/)</span>
...
## <span id="head30">[131\. 分割回文串](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/palindrome-partitioning/)</span>
...
## <span id="head31">[139\. 单词拆分](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/word-break/)</span>



## <span id="head32">[140\. 单词拆分 II](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/word-break-ii/)</span>



## <span id="head33">[208\. 实现 Trie (前缀树)](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/implement-trie-prefix-tree/)</span>
...
## <span id="head34">[212\. 单词搜索 II](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/word-search-ii/)</span>
...
## <span id="head35">[242\. 有效的字母异位词](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/valid-anagram/)</span>
...
```
## <span id="head36">[387\. 字符串中的第一个唯一字符](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/first-unique-character-in-a-string/)</span>
...
## <span id="head37">[344\. 反转字符串](https://link.zhihu.com/?target=https%3A//leetcode-cn.com/problems/reverse-string/)</span>
...
## <span id="head38"> [3.无重复字符的最长子串长度](https://leetcode-cn.com/problems/longest-substring-without-repeating-characters/)</span>
